...
<body>
	...
	<div class="join_agree">
		...
		<span style="float: right;"><span class="sp">* </span>는 필수사항
			입니다</span>
		<form action="./memberUpdate" method="post" class="joinForm"
			...
			<table
				...
				<tr class="join_tr" style="border-top: 1px #ddd solid;">
					...
					<td>&emsp;&emsp;&nbsp;${member.id}<input type="hidden"
						value="${member.id}" name="id"> <span id="result"></span>
					</td>
				</tr>
				...
				<tr class="join_tr">
					...
					<td><input type="text" class="Join_input"
						value="${member.name}" id="name" name="name"></td>
				</tr>
				...
				<tr class="join_tr">
					...
					<td><input type="text" class="Join_input"
						value="${member.age}" id="age" name="age"><span
				...
				<tr class="join_tr">
					...
					<td><input type="email" class="Join_input"
						value="${member.email}" id="email" name="email"></td>
				</tr>
				...
				<tr class="join_tr">
					...
					<td><input type="text" class="Join_input addrSearch"
						value="${addar[0]}" placeholder="      우편번호" id="postcode"
						name="addr" readonly="readonly" style="margin-bottom: 5px;">
						<button type="button" class="addrSearch" id="addrSearch" style="">주소찾기</button>
						<br> <input type="text" class="Join_input addrSearch"
						value="${addar[1]}" placeholder="      기본주소" id="roadAddress"
						name="addr" readonly="readonly" style="width: 35%"><br>
						<input type="text" class="Join_input" value="${addar[2]}"
						placeholder="      나머지주소" id="addr" name="addr"
						style="width: 35%; margin-top: 5px;"></td>
				</tr>
				...
				<tr class="join_tr">
					...
					<td><input type="date" class="Join_input" id="birth"
						name="birth" value="${member.birth}"></td>
				</tr>
				...
				<tr class="join_tr">
					...
					<td>&emsp;&emsp;&nbsp;${member.job}<input type="hidden"
						value="${member.job}" name="job">
					</td>
				</tr>
				...
				<tr class="singer">
					...
					<td><input type="text" class="Join_input"
						value="${member.teamName}" id="teamName" name="teamName"></td>
				</tr>
				...
				<tr class="singer">
					...
					<td><input type="text" class="Join_input"
						value="${member.position}" id="position" name="position"></td>
				</tr>
				...
				<tr class="singer">
					...
					<td><input type="text" class="Join_input"
						value="${member.sns}" id="sns" name="sns"></td>
				</tr>
					...
					<form action="./memberDelete" method="post" name="frm2">
						...
						<p>
							<input type="password" id="pwCheck2"
								style="border-radius: 4px; border: 1px solid #ccc; height: 20px; width: 50%"><span
								id="pwcheck3"></span>
						</p>
						<br>
